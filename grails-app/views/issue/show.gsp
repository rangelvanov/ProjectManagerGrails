    ...
    <body>
        ...
        <div id="show-task" class="content" role="main">
            <div class="col-md-12">
                ...
                <f:field property="priority" label="Priority: "> ${issue.priority}" </f:field>
                <f:field property="description" label="Description: ">< ${issue.description}" </f:field>
                    ...
                    <div class="container">
                        <div class="media comment-box">
                            <div class="media-body">
                                <h4 class="media-heading">${com.ProjectManager.auth.User.get(c.userId).username} <small><i><g:formatDate date="${c.created}" type="datetime" style="MEDIUM"></g:formatDate></i></small>
                                </h4>
